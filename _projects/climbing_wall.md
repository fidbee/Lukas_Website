...
img: assets/img/projects/climbing_wall/wall_completed.jpg
importance: 1
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/projects/climbing_wall/wall_completed.jpg" title="wall_completed" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    Completed wall
